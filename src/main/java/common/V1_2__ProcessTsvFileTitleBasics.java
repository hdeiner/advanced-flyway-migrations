...
public class V1_2__ProcessTsvFileTitleBasics extends ProcessTsvFile {
    public V1_2__ProcessTsvFileTitleBasics(Context context, String tsvFileName) {
    ...
    public void processRow(String[] row) {
        try {
            ...
            if (tsvProcessedCount != 0) {
                sql = "INSERT INTO TITLE (NCONST, TITLE_TYPE, PRIMARY_TITLE, ORIGINAL_TITLE, IS_ADULT, START_YEAR, END_YEAR, RUNTIME_MINUTES) VALUES (";
                sql += "'" + row[0] + "' "; // tconst
                ...
                if (row[8] != null) {
                    ...
                    for (String genre : genres) {
                        sql = "INSERT INTO TITLE_GENRE (NCONST, GENRE) VALUES (";
                        sql += "'" + row[0] + "', "; // tconst
                        sql += "'" + genre + "'"; // genre
                        sql += ")";
                        statement.execute(sql);
